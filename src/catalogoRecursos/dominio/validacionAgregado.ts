...
export type AggregateViolationCode = "HIERARCHY_REFERENCE_INVALID" | "PRINCIPAL_UNIT_COUNT" | "UNIT_INACTIVE" | "OPTION_SET_EMPTY" | "ASSIGNMENT_SELECTION_INVALID" | "RULE_REFERENCE_INVALID" | "RULE_RESULT_INVALID" | "RULE_CONFLICT" | "PRESENTATION_COUNT" | "PRESENTATION_TOKEN_INVALID" | "CATALOG_LIMIT_EXCEEDED";
