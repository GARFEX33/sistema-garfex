...
export type AggregateViolationCode = "HIERARCHY_REFERENCE_INVALID" | "PRINCIPAL_UNIT_COUNT" | "UNIT_INACTIVE" | "PRESENTATION_COUNT" | "PRESENTATION_TOKEN_INVALID" | "CATALOG_LIMIT_EXCEEDED";
