...
export type AggregateViolationCode = "HIERARCHY_REFERENCE_INVALID" | "PRINCIPAL_UNIT_COUNT" | "UNIT_INACTIVE" | "OPTION_SET_EMPTY" | "ASSIGNMENT_SELECTION_INVALID" | "PRESENTATION_COUNT" | "PRESENTATION_TOKEN_INVALID" | "CATALOG_LIMIT_EXCEEDED";
